...
import com.fdunlap.focus_v2.comparators.PackageInfoComparator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateGlobalAppsList() {
        ...
        for (PackageInfo pi : packageList) {
            if (!isSystemPackage(pi) && pi.applicationInfo.name != null) {
                Log.d("MAIN", "Added " + pi.packageName + " to allApps vector.");
                packageList1.add(pi);
            }
        }
