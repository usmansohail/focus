...
public class deleteOneNotification {
    ...
    public void deleteNotification() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.profile_name_edit_text),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Test profile"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.notification_list_delete),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.Main_Frame),
                                        0),
